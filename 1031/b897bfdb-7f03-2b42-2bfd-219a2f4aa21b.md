...
| _MenuName_|Erforderlich|**Variant**| Sie können eine der folgenden systeminternen Konstanten verwenden. <BR/>**acFile** <BR/>**acEditMenu** <BR/>**acRecordsMenu** <BR/>Sie können **acRecordsMenu** nur für die Menüleiste "Formularansicht" in Microsoft Access Version 2.0- und Microsoft Access 95-Datenbanken verwenden. Verwenden Sie für andere Menüs die Nummer des gewünschten Menüs in der Liste des Name-Arguments (zählen Sie in der Liste abwärts, beginnend bei 0). Die entsprechende Anzeige wurde in früheren Microsoft Access-Versionen im Makrofenster dargestellt.|
| _Command_|Erforderlich|**Variant**| Sie können eine der folgenden systeminternen Konstanten verwenden. <BR/>**acNew** <BR/>**acSaveForm** <BR/>**acSaveFormAs** <BR/>**acSaveRecord** <BR/>**acUndo** <BR/>**acCut** <BR/>**acCopy** <BR/>**acPaste** <BR/>**acDelete** <BR/>**acSelectRecord** <BR/>**acSelectAllRecords** <BR/>**acObjacRefreshect** <BR/>Verwenden Sie für andere Befehle die Nummer des gewünschten Befehls in der Liste des Arguments Befehl (zählen Sie in der Liste abwärts, beginnend bei 0). Die entsprechende Anzeige wurde in früheren Microsoft Access-Versionen im Makrofenster dargestellt.|
| _Subcommand_|Optional|**Variant**| Sie können eine der folgenden systeminternen Konstanten verwenden. <BR/>**acObjectVerb** <BR/>**acObjectUpdate** <BR/>Die Konstante **acObjectVerb** stellt den ersten Befehl im Untermenü des Befehls **Objekt** aus dem Menü **Bearbeiten** dar. Der Objekttyp legt den ersten Befehl des Untermenüs fest. Für ein Paintbrush-Objekt, das bearbeitet werden kann, lautet dieser Befehl z. B. "Bearbeiten". <BR/>Verwenden Sie für andere Befehle in Untermenüs die Nummer des gewünschten Unterbefehls in der Liste des Arguments Unterbefehl (zählen Sie in der Liste abwärts, beginnend bei 0). Die entsprechende Anzeige wurde in früheren Microsoft Access-Versionen im Makrofenster dargestellt.|
| _Version_|Optional|**Variant**|Verwenden Sie die systeminterne Konstante  **acMenuVer70** für Code, der für Microsoft Access 95-Datenbanken geschrieben wurde, die systeminterne Konstante **acMenuVer20** für Code, der für Microsoft Access-Datenbanken, Version 2.0, geschrieben wurde, und die systeminterne Konstante **acMenuVer1X** für Code, der für Microsoft Access-Datenbanken, Version 1.x, geschrieben wurde. Dieses Argument ist nur in Visual Basic verfügbar. <BR/><BR/>**Hinweis**<BR/>  Der Standardwert für dieses Argument ist  **acMenuVer1X**, der gesamte code, der für Microsoft Access-Datenbanken, Version 1.x, geschrieben wurde, wird daher unverändert ausgeführt. Wenn Sie Code für eine Microsoft Access 95- Datenbank oder eine Microsoft Access-Datenbank, Version 2.0 schreiben und die Menübefehle von Microsoft Access 95 oder Version 2.0 mit der **DoMenuItem** -Methode verwenden möchten, müssen Sie dieses Argument auf **acMenuVer70** oder **acMenuVer20** festlegen. Auch wenn Sie im Makrofenster in den Listen für die Aktionsargumente für Menüleiste, Menüname, Befehl und Unterbefehle abwärts zählen, um die für die Argumente in der  **DoMenuItem** -Methode zu verwendenden Zahlen abzurufen, müssen Sie die Microsoft Access 95-Listen verwenden, wenn das Version-Argument **acMenuVer70** ist, die Microsoft Access-Liste, Version 2.0, wenn das Version-Argument "Version" ist, und die Microsoft Access-Listen, Version 1.x, wenn Version **acMenuVer1X** (oder leer ist). <BR/><BR/>**Hinweis**<BR/>  Es gibt keine  **acMenuVer80** -Einstellung für dieses Argument. Sie können die **DoMenuItem** -Methode nicht zum Anzeigen von Access-Befehlen verwenden (bereits vorhandene **DoMenuItem** -Methoden in Visual Basic-Code funktionieren aber weiterhin). Verewnden Sie stattdessen die **RunCommand** -Methode. |
