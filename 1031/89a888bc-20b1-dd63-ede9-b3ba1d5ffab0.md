...
| _RefersTo_|Optional|**Variant**|Beschreibt, worauf der Name sich bezeiht, (in Englisch mit A1-Schreibweise), wenn die Parameter RefersToLocal, RefersToR1C1 und RefersToR1C1Local nicht angegeben sind. **Hinweis**   **Nothing** wird zurückgegeben, wenn die Referenz nicht vorhanden ist. |
...
| _MacroType_|Optional|**Variant**| Der Makrotyp, der von einem der folgenden Werte bestimmt wird: 1 - benutzerdefinierte Funktion ( **Function** -Prozedur) 2 - Makro ( **Unter** prozedur) 3 oder nicht angegeben - None (der Name bezieht sich nicht auf eine benutzerdefinierte Funktion oder ein Makro)|
